...
export const error500 = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'pageBuilder',
      description: 'Bygg norsk 500-side med komponenter og innhold. Tittel er allerede H1.',
      group: 'no',
    }),
    ...
    defineField({
      ...
      type: 'string',
      description: 'Main title for the 500 page in English',
      group: 'en',
      initialValue: '500 - Server Error',
    }),
    defineField({
      name: 'content_en',
      title: 'Page content (English)',
      type: 'pageBuilder',
      description: 'Build English 500 page with components and content. Title is already H1.',
      group: 'en',
      components: {
